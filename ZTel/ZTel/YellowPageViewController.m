...
- (void)sendSMS:(id)sender
{
    if ([MFMessageComposeViewController canSendText]) {
        ...
        [controller presentViewController:smsController
                                 animated:YES
                               completion:NULL];
    }
    else {
...
+ (void)initialize
{
    ...
    if (![fm fileExistsAtPath:[Telephone telephoneDBPath]]) {
        NSString *dir = [[Telephone telephoneDBPath] stringByDeletingLastPathComponent];
        ...
        NSError *error = nil;
        if (![fm moveItemAtPath:[[NSBundle mainBundle] pathForResource:@"zjutel"
                                                                ofType:@"db"]
                         toPath:[Telephone telephoneDBPath]
                          error:&error])
            NSLog(@"%@", error);
    }
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    YellowPageViewController *detailViewController = [self.storyboard instantiateViewControllerWithIdentifier:@"YellowPageViewController"];
    // ...
